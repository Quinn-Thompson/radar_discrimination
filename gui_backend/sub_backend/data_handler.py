...
class VisualizationWrapper():
    ...
    def __init__(self, main_window: MainWindow) -> None:
        ...
        self.basic_graohs = ViewTransformsBackend(self.main_window, self.main_window.sub_window_widgets.data_display)
        self.basic_graohs = CaptureBackend(self.main_window, self.main_window.sub_window_widgets.capture_window, self.data_handler)